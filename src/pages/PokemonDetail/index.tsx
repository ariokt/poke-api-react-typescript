      ...
      <div className='bg-white p-8 min-h-[100vh]'>
        {
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex flex-col translate-y-[-1rem]'>
              ...
              <table className='mt-8 mx-auto w-fit table-auto bg-white border border-gray-300'>
                <thead>
                  <tr>
                    {detailPokemon.stats.map((stat: any) => <th key={stat.stat.name} className='px-4 py-2 border-b-2 border-gray-300 text-sm'>{stat.stat.name}</th>)}
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    {detailPokemon.stats.map((stat: any) => <td key={stat.stat.name} className='px-4 py-2 border-b-2 border-gray-300 text-sm'>{stat.base_stat}</td>)}
                  </tr>
                </tbody>
              </table>
            </div>
